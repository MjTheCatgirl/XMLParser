...
class ApplicationController < ActionController::Base
    ...
    def initialize(property_id, property_name, email)
   ...
   def email
	...
	# 
	# This works as expected for the provided XML file and displays results in browser
	def scrape_properties
		...
		# correct value.
  		...
  		@properties.each do |node|
  			...
  			newName = node.at_xpath(".//MarketingName").text
